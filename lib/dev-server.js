...
const apiRoutes = { '/api/extract': require('../api/extract'), '/api/refine': require('../api/refine'), '/api/sessions': require('../api/sessions'), '/api/projects': require('../api/projects'), '/api/design-docs': require('../api/design-docs') };
...
http.createServer(async (req, res) => {
  ...
  if (apiRoutes[url.pathname]) {
    ...
    return apiRoutes[url.pathname](req, r);
  }
